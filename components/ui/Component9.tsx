...
import {data7} from "@/lib/constants";
    ...
    return (
        ...
        >
            ...
            >
                {data7.map((item, idx) => (
                    <li
                        className="w-[350px] max-w-full relative rounded-2xl  flex-shrink-0  px-8 py-6 md:w-[450px] bg-[#f5f7f8]"
                ...
                <span className="flex flex-col gap-1">
                  <span className=" text-sm leading-[1.6] text-black/70 font-normal">
                    {item.name}
                  </span>
